...
if exist "C:\Program Files\mitmproxy\bin\mimtproxy.exe" (
    start cmd.exe /k "cd /d "%MITMPROXYSCRIPTFOLDER%" && "C:\Program Files\mitmproxy\bin\mimtproxy.exe" -s mitm-redirect-traffic.py -p 8080"
) else (
